  ...
  <main class="main">
    ...
    <section id="gallery-details" class="gallery-details section">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <img src="{{ asset('asset/assets/img/gallery/WhatsApp Image 2024-11-18 at 14.24.54_4c0c2fa2.jpg') }}" 
          ...
          <div class="col-lg-8" data-aos="fade-up">
            <div class="portfolio-description">
              ...
              <div class="testimonial-item">
                ...
                <div>
                  <img src="{{ asset('asset/assets/img/testimonials/testimonials-2.jpg') }}" class="testimonial-img" alt="">
                  <h3>Sara Wilsson</h3>
                  <h4>Designer</h4>
                </div>
              </div>
